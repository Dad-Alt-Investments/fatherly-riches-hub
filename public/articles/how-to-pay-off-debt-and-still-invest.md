...
**Category:** Credit & Loans | Financial Independence | Guides & How-To's
**Target Keywords:** pay off debt, wealth building, debt payoff while investing, how to pay off debt and invest
**Tags:** Credit & Loans · Financial Independence · Guides & How-To's
...
> **Rule of Thumb:** If your interest rate is higher than the expected return on your investment (generally use 7–10% for diversified stock [best platforms for index fundss](/article/best-platforms-to-buy-index-funds)), pay off debt first. If it's lower, invest the difference.
...
4. When that debt is eliminated, roll its entire payment toward the next-highest-rate debt
...
**How it works:**
1. List every debt from smallest balance to largest (ignore interest rates)
2. Make the minimum payment on every debt
3. Direct every extra dollar toward the smallest-balance debt
4. When that debt is eliminated, roll its payment onto the next-smallest debt
5. Repeat until all debts are paid
...
1. **Calculate whether it makes sense.** On a $6,000 balance, a 5% balance transfer fee costs $300 upfront. If you'd pay $1,200+ in interest staying at 22% APR over 18 months, the transfer still saves you $900+.
2. **Only do this if you will not add new purchases to the card.** Adding new charges while a balance transfer is in progress can result in those purchases accruing interest immediately, negating your savings.
3. **Set up automatic payments** to pay off the entire transferred balance before the 0% period ends. When the intro period expires, any remaining balance begins accruing interest at the full variable APR — which is typically 17–28%.
4. **Stop using the original card** for new purchases, but don't close it. Keeping the account open (with a $0 balance) maintains your available credit and improves your credit utilization ratio.
...
1. **Stopping all investing while paying off debt.** You miss employer match dollars that can never be recovered. Even a single year without capturing a full match is a guaranteed permanent loss.

2. **Paying off low-rate mortgage debt aggressively instead of investing.** Sending an extra $500/month toward a 3.5% mortgage while your Roth IRA sits unfunded is voluntarily choosing a 3.5% return over a historically expected 10% return. The math is painful over 20+ years.

3. **Using a balance transfer and then charging up the original cards again.** This is the most common consolidation trap. You now have double the debt and no interest-free period on the original balances.

4. **Not building any emergency fund before attacking debt.** Without a buffer, the first emergency — a car repair, medical bill, or job disruption — sends you right back to your credit cards.

5. **Treating minimum payments as optional.** Missing minimum payments triggers penalty APRs (often 29.99%), late fees, and credit score damage. These multiply the cost of debt exponentially. Automate minimum payments on every account before anything else.

6. **Waiting until all debt is gone to open a Roth IRA.** If you have low-rate student loans, you could be "waiting" for 10–20 years to open an account that should have been growing tax-free the entire time.
