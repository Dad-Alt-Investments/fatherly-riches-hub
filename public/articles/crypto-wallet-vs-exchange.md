...
- **A crypto exchange is like a bank.** You deposit money, the bank holds it, and you access it through an account. The bank controls the vault. If the bank fails, gets hacked, or freezes your account, you may not be able to get your money out.

- **A crypto wallet is like a personal safe.** You hold the only key. No one else can open it. If you lose the key (your seed phrase), no locksmith can help you — the crypto is gone. But no bank failure, exchange hack, or regulatory freeze can touch it.
...
1. **Write it on paper with a ballpoint pen, immediately after setup.** Number each word. Store it privately.
2. **Never store it digitally.** Not in Notes, not in a password manager, not in an email draft, not in Google Drive, not as a phone photo. Any digital copy can be stolen by malware.
3. **Never share it with anyone, for any reason.** Legitimate support staff from Ledger, Trezor, MetaMask, or any exchange will never ask for your seed phrase. Ever.
4. **Store a second physical copy in a separate, secure location.** A safe at home plus a safe deposit box, for example. If your house burns down and your only copy of the seed phrase was in it, the crypto is gone.
...
1. **Exchange account** (Coinbase, Kraken, or Gemini) — for buying, selling, and converting to/from dollars. Keep only what you're actively trading here.

2. **Hot wallet** (Coinbase Wallet, MetaMask, or Trust Wallet) — for small amounts you use regularly, DeFi access, NFT purchases, or anything you want to move quickly. Free to set up, non-custodial.

3. **Hardware wallet** (Trezor Safe 3 or Ledger Nano X) — for long-term savings. Any holding over $1,000 should be here. Your keys, your coins, fully offline.
...
[^1]: Gemini Cryptopedia. "Crypto Wallets: Custodial vs. Non-Custodial Wallets." Gemini. https://www.gemini.com/cryptopedia/crypto-wallets-custodial-vs-noncustodial

[^2]: Ledger Academy. "What Are the Different Types of Crypto Wallets?" Ledger. July 2025. https://www.ledger.com/academy/topics/crypto/types-of-crypto-wallets

[^3]: MoonPay. "Custodial vs Non-Custodial Wallets: What's the Difference?" https://www.moonpay.com/learn/blockchain/custodial-vs-non-custodial-wallets

[^4]: CryptoSlate. "MetaMask Wallet Review 2026: Security, Fees, Chains and Best Use Cases." Updated March 13, 2026. https://cryptoslate.com/crypto-wallets/metamask-review/

[^5]: CoinGecko. "Top 7 Hot Wallets in 2026." March 2026. https://www.coingecko.com/learn/top-hot-software-wallets-crypto

[^6]: Koinly. "MetaMask vs. Trust Wallet: Which Is Best In 2026?" January 2026. https://koinly.io/blog/metamask-vs-trustwallet/

[^7]: BitGo. "Custodial vs. Non-Custodial Wallets: Where is Your Crypto Held?" https://www.bitgo.com/resources/blog/custodial-vs-non-custodial-wallet/

[^8]: ChainUP. "Custodial vs Non-Custodial Wallets: Your 2026 Crypto Wallet Guide." March 2026. https://www.chainup.com/blog/comprehensive-guide-custodial-vs-non-custodial-hot-wallets/
